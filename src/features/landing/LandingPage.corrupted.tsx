import { useStat  {
    icon: "🤝",
    title: "Matching emploi garan    text: "Validation de compétences en ligne, accessible 24h/24 depuis n'importe où",i",
...
const features = [
  ...
  {
    icon: "🧾",
    title: "Prouver ce que tu sais faire",
    desc: "Analyse une offre d’emploi, réalise une mission, génère un rapport et joins-le à ta candidature.",
  },
  {
    icon: "⚡",
...
const advantages = [
  ...
  },
  {
    ...
    text: "Accessible depuis n’importe quel navigateur, aucune configuration requise",
  },
  {
    icon: (
      <svg
              ...
              <div className="relative">
                ...
                <div className="relative bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 overflow-hidden shadow-2xl transform-gpu hover:translate-y-[-5px] transition-all duration-300">
                  ...
                  <p className="text-white/70 mb-6">
                    ...
                    expérience fluide et réactive, même pour les projets les
                    plus exigeants.
                  </p>
